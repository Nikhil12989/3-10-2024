...
const Application_companyregistration = () => {
    ...
    useEffect(() => {
        const fetchLicenseData = async () => {
            try {
                const response = await axios.get(`http://192.168.1.50:5000/api/companyRegistration/getCompanyRegistration/${id}`);
    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 mt-5 mb-10 max-w-6xl mx-auto bg-gray-200 rounded-lg shadow-lg">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8">
                Company Registration Application</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                <div className="bg-white shadow-md p-4 sm:p-6 rounded-lg space-y-4">
                    ...
                    {[
                        { label: 'Full Name', value: licenseData.fullName },
                        { label: 'Company Name', value: licenseData.companyName },
                        { label: 'Address', value: licenseData.address },
