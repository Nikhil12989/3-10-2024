...
const Add_blogs = () => {
  return (
    <div className='flex1'>
      ...
      >
        <section class="max-w-4xl mb-12 p-6 mt-10 mx-auto bg-gradient-to-r from-blue-500 to-blue-800 rounded-md shadow-xl dark:bg-gray-800 transition-transform duration-300">
          <form>
          ...
          <table className="w-full min-w-[700px] mx-auto text-sm md:text-md lg:text-lg bg-white shadow-md rounded-lg border-collapse">
            <thead>
              <tr className="bg-gradient-to-r from-blue-500 to-blue-950">
                ...
                <th className="px-2 md:px-4 py-2 border-2 border-[#3f4b74] text-white">Blog Title</th>
                <th className="px-2 md:px-4 py-2 border-2 border-[#3f4b74] text-white">Image</th>
            ...
            <tbody>
              <tr className="bg-white">
                ...
                <td className="px-2 md:px-4 py-2 border-2 border-[#3f4b74] text-center text-[#797D8C]">Digital marketing</td>
                ...
                <td className="px-2 md:px-4 py-2 border-2 border-[#3f4b74] text-center text-[#797D8C]"> digital marketing agahakalangydufnfjf</td>
